<?php
	$sitelink = '[domain]/pesapalPHPExample';
?>
<!DOCTYPE html>
...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link rel="shortcut icon" href="<?php echo $sitelink ?>/images/favicon.ico">
    <link rel="apple-touch-icon" href="<?php echo $sitelink ?>/images/apple-touch-icon.png">
	...
	<link href="/css1/style_forms_validation.css" rel="stylesheet" type="text/css">
    ...
    <script src="<?php echo $sitelink ?>/js/ga.js" async type="text/javascript"></script><script src="<?php echo $sitelink ?>/js/jquery_002.js"></script>
...
<ul id="pp-mainnav">
<li id="tm_020"><a href="https://www.pesapal.com/personal/index">Personal</a></li><li id="tm_050"><a href="https://www.pesapal.com/business/index">Business</a></li></ul>
				</div>				
			</div>
		</div>
	</div>
